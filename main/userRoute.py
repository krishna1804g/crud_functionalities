...
def register_new_user():
    ...
    new_user = User(email=email, password=hashed_password, ph_number=ph_number, username=username, admin_role=admin_role, city=city, state=state, community=community)
